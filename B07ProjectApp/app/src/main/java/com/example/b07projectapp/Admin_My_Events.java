...
public class Admin_My_Events extends AppCompatActivity {
        ...
        ref.child("event").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    if (dataSnapshot.child("poster").getValue(String.class).equals(getIntent().getStringExtra("username"))){
            ...
            public void onClick(View view, int position) {
                ...
                if(lists.isEmpty())
                    ...
                    if (getIntent().getStringExtra("username") != null) {
                        String stStr = getIntent().getStringExtra("username");
                        intent.putExtra("username", stStr);
                    }
