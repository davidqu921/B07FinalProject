...
public final class ActivityAdminViewComplaintBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ActivityAdminViewComplaintBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAdminViewComplaintBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_admin_view_complaint, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAdminViewComplaintBinding bind(@NonNull View rootView) {
