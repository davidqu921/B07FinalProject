...
public final class ActivityAdminEventsBinding implements ViewBinding {
  ...
  private ActivityAdminEventsBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button MyEventBack, @NonNull RecyclerView MyEventsList,
      @NonNull SearchView searchView2, @NonNull TextView textView5) {
  ...
  public static ActivityAdminEventsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAdminEventsBinding((ConstraintLayout) rootView, MyEventBack, MyEventsList,
