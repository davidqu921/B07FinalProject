...
public final class ActivityAdminSignUpBinding implements ViewBinding {
  ...
  private ActivityAdminSignUpBinding(@NonNull ConstraintLayout rootView, @NonNull Button button5,
      ...
      @NonNull EditText editTextAdminUsername, @NonNull Button eventListBack,
  ...
  public static ActivityAdminSignUpBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAdminSignUpBinding((ConstraintLayout) rootView, button5, editTextAdminName,
          editTextAdminPassword, editTextAdminUsername, eventListBack, textView6);
    }
